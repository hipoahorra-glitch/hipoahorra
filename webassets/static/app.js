    ...
    const drawInsuranceChart = () => {
        ...
        const drawGap = () => {
            ...
            for (let index = 0; index < points.length; index += 1) {
                ...
                context.beginPath();
                context.moveTo(x(index), y(points[index].bankAnnual));
                context.lineTo(x(index), y(points[index].externalAnnual));
                context.stroke();
            }
            context.restore();
        };
        ...
        drawGrid();
        drawGap();
        drawLine('bankAnnual', '#4c7b86');
        drawLine('externalAnnual', '#f59e0b');
        drawXAxis();
